...
VALUES
    ...
    ('Санкт-Петербург','59.917458, 30.333957', 'Россия', 'Новый 4-звездочный дизайнерский отель бизнес-класса. Бесплатная гостевая парковка для автомобилей, профессиональный клининг, индивидуальный подход к каждому гостю.', 'ilyina.nastasya2002@gmail.com', '13', 'ACQUALINA', 'Подъездной переулок'),
    ('Казань', 'Россия','55.793800, 49.103095', 'Из окон отеля открывается живописный вид на стены Казанского Кремля и рек Булак.', 'ilyina.nastasya2002@gmail.com', '5', 'Мираж', 'Московская');
